...
void Excersize_2_21(int solution, int answer)
{
	...
	printf("\n\n");
	printf("2-21 \n");
	printf("만약 높이가 %.0lf m인 빌딩 옥상에서 지면을 향해 수직으로 물체를 낙하시켰다고 하자.\n\n", h);
	...
	if (solution == SHOW)
	{
		...
		printf("이때 자유낙하 운동이므로 a 가속도는 g 중력가속도로 대입한다.\n");
		printf("가속도는 중력가속도를 이용하여 %.1lf m/s^2는 다음과 같습니다. \n", g);
		printf("v0는 처음에 낙하하므로 v0는 %.0lf m/s이다.\n", initialvelocity);
		printf("=================================================================\n");
		printf("\n\n\n");	
	}
	...
	if (answer == SHOW)
	{
		...
		t = sqrt(2 * h / g);
		printf("따라서 %.2lf s = sqrt(2 * %.0lf m / %.1lf m/s^2)이다.\n\n", t, h, g);
		printf("그러므로 t^2을 구하고 sqrt로 %.2lf s의 값이 나온다.\n\n",t);
	...
	if (solution == SHOW)
	{
		...
		printf("v는 속도, v0는 처음속도, a는 가속도, t는 시간입니다.\n");
		printf("이때 높이이므로 a 가속도는 g 중력가속도로 대입한다.\n");
		g;
		printf("가속도는 중력가속도를 이용하여 %.1lf m/s^2는 다음과 같습니다. \n", g);
		printf("v0는 처음에 낙하하므로 v0는 %.0lf m/s이다.\n", initialvelocity);
		printf("=================================================================\n");
	...
	if (answer == SHOW)
	{
		...
		t = sqrt(2 * h / g);
		v = g * t;
		printf("따라서 a문제에서 구한 t를 대입하여 %.1lf m/s = %.1lf m/s^2 * %.2lf m/s^2 입니다.\n\n", v, g, t);
		printf("그러므로 대입한 t랑 중력가속도 g랑 곱하여 지면에 도달하기 직전의 속도 %.1lf m/s가 나온다. \n", v);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
}
