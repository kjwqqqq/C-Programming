...
void Excersize_2_1(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		...
		printf("대형기동헬기가 북쪽으로 이동한거리는 %.1lf km는 다음과 같습니다. \n", x_displacement);

		printf("대형기동헬기가 남쪽으로 이동한거리는 %.1lf km는 다음과 같습니다. \n\n", south_distance);
	}
	...
	if (answer == SHOW)
	{
		...
		printf("(a) 처음 기지로부터 마지막 도착 지점까지의 헬기의 변위는 얼마인가 ? \n\n");
		printf("대형기동헬기가 기지로부터 마지막 도착지점은 다음과 같습니다. : %.1lf \n", displacement);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
	...
	if (answer == SHOW)
	{
		...
		printf("(b) 또 이날 헬기가 움직인 총 거리는 얼마인가 ? \n\n");
		displacement = x_displacement + south_distance;
		printf("대형기동헬기가 총 움직인 거리의 합은 다음과 같습니다. : %.1lf km \n", displacement);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
...
void Excersize_2_21(int solution, int answer)
{
	...
	if (solution == SHOW)
	{
		printf("\n\n\n");
		printf("=================================================================\n");
		printf("관련공식은 y = y0 + v0t + 1/2 * a * t^2입니다. \n");
	...
	if (answer == SHOW)
	{
		...
		printf("물체가 지면으로 떨어지는 시간은 다음과 같습니다. : %.2lf s \n", time);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
	...
	if (answer == SHOW)
	{
		...
		printf("(b) 지면에 도달하기 직전의 속도를 구하라.\n\n");
		time = sqrt(2 * height / accelerationofgravity);
		printf("물체가 지면으로 떨어지는 시간은 다음과 같습니다. : %.2lf m/s^2 \n", time);
		velocity = accelerationofgravity * time;
		printf("물체가 지면으로 떨어지는 속도는 다음과 같습니다. : %.1lf m/s \n", velocity);
		printf("=================================================================\n");
		printf("\n\n\n");
	}
}
